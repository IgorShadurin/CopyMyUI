...
const en = {
  ...
  adminPage: {
    ...
    userRegistrationsDescription:
      "Daily sign-ups for the selected period.",
  ...
  adminComponentsPage: {
    ...
    description:
      "Review every component by category and quickly edit, decline, or delete submissions.",
    ...
    confirmDeclineAction:
      "Decline this component and remove it from the public gallery?",
    confirmDeleteAction:
      "Delete this component permanently? This cannot be undone.",
    confirmBulkDeclineAction:
      "Decline selected components and remove them from the public gallery?",
    confirmBulkDeleteAction:
      "Delete selected components permanently? This cannot be undone.",
    selectComponentAria: "Select component",
    viewPublicAction: "Open public page",
    editTitle: "Edit component metadata",
    editDescription:
      "Update card copy and category placement for this component.",
...
const es: typeof en = {
  ...
  adminPage: {
    ...
    userRegistrationsDescription:
      "Altas diarias para el período seleccionado.",
  ...
  adminComponentsPage: {
    ...
    noticeBulkDeclined:
      "Los componentes seleccionados fueron rechazados y retirados de la galería pública.",
    noticeBulkDeleted: "Los componentes seleccionados fueron eliminados.",
    eyebrow: "Controles de admin",
    title: "Gestionar componentes",
    description:
      "Revisa todos los componentes por categoría y edita, rechaza o elimina envíos rápidamente.",
    ...
    confirmDeclineAction:
      "¿Rechazar este componente y retirarlo de la galería pública?",
    confirmDeleteAction:
      "¿Eliminar este componente de forma permanente? Esta acción no se puede deshacer.",
    confirmBulkDeclineAction:
      "¿Rechazar los componentes seleccionados y retirarlos de la galería pública?",
    confirmBulkDeleteAction:
      "¿Eliminar permanentemente los componentes seleccionados? Esta acción no se puede deshacer.",
    selectComponentAria: "Seleccionar componente",
    viewPublicAction: "Abrir página pública",
    editTitle: "Editar metadatos del componente",
    editDescription:
      "Actualiza el texto de la tarjeta y la categoría principal de este componente.",
...
const ru: typeof en = {
  ...
  adminPage: {
    ...
    userRegistrationsDescription:
      "Ежедневные регистрации за выбранный период.",
  ...
  adminComponentsPage: {
    ...
    noticeBulkDeclined:
      "Выбранные компоненты отклонены и сняты с публичной галереи.",
    noticeBulkDeleted: "Выбранные компоненты удалены.",
    eyebrow: "Админ-панель",
    title: "Управление компонентами",
    description:
      "Проверяйте все компоненты по категориям и быстро редактируйте, отклоняйте или удаляйте публикации.",
    ...
    confirmDeclineAction:
      "Отклонить этот компонент и убрать его из публичной галереи?",
    confirmDeleteAction:
      "Удалить этот компонент навсегда? Это действие нельзя отменить.",
    confirmBulkDeclineAction:
      "Отклонить выбранные компоненты и убрать их из публичной галереи?",
    confirmBulkDeleteAction:
      "Удалить выбранные компоненты навсегда? Это действие нельзя отменить.",
    ...
    editDescription:
      "Обновите текст карточки и основную категорию этого компонента.",
...
const de: typeof en = {
  ...
  adminPage: {
    ...
    userRegistrationsDescription:
      "Tägliche Registrierungen für den ausgewählten Zeitraum.",
  ...
  adminComponentsPage: {
    ...
    noticeBulkDeclined:
      "Ausgewählte Komponenten wurden abgelehnt und aus der öffentlichen Galerie entfernt.",
    noticeBulkDeleted: "Ausgewählte Komponenten wurden gelöscht.",
    eyebrow: "Admin-Steuerung",
    title: "Komponenten verwalten",
    description:
      "Prüfe alle Komponenten nach Kategorie und bearbeite, lehne ab oder lösche Einreichungen schnell.",
    ...
    confirmDeclineAction:
      "Diese Komponente ablehnen und aus der öffentlichen Galerie entfernen?",
    confirmDeleteAction:
      "Diese Komponente dauerhaft löschen? Das kann nicht rückgängig gemacht werden.",
    confirmBulkDeclineAction:
      "Ausgewählte Komponenten ablehnen und aus der öffentlichen Galerie entfernen?",
    confirmBulkDeleteAction:
      "Ausgewählte Komponenten dauerhaft löschen? Das kann nicht rückgängig gemacht werden.",
    ...
    editDescription:
      "Aktualisiere Kartentext und Hauptkategorie dieser Komponente.",
  ...
  moderationForm: {
    ...
    confirmApprove:
      "Diese Revision freigeben und in der öffentlichen Galerie veröffentlichen?",
    confirmDecline:
      "Diese Revision ablehnen und zur Überarbeitung an den Ersteller zurückgeben?",
  },
  signInPage: {
